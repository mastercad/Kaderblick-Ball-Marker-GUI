...
class Session:
    def __init__(self):
        ...
        self.videos = []
        self.timeline = []
        self.autosave_path = "autosave/session.json"
    ...
    def move_marker(self, marker, new_position):
        ...
        self.undo_stack.append(Action("move", marker, prev_position))
        self.redo_stack.clear()

    def resize_marker(self, marker, new_radius):
        prev_radius = marker.radius
        marker.radius = new_radius
        self.undo_stack.append(Action("resize", marker, prev_radius))
        self.redo_stack.clear()
